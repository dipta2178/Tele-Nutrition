...
<title>Tele-Nutritionist Doctor login</title>
</head>
...
width:100%;
height:100vh;
background-image:url(../CSE499/pic/doc_log.jpg);
...
?>
 ...
 <h1  class=" text-center font-weight-bold text-BLUE ">Doctor Login</h1>
        </div>
...
Not Yet A Member? <a href=doctor_registration.php><strong style="color:#de1010">Register</strong></a></br>
