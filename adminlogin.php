...
<title>Tele-Nutritionist Admin login</title>
</head>
...
width:100%;
height:100vh;
background-image:url(../CSE499/pic/add_log.jpg);
...
?>
  ...
  <!-- Login -->
      <div class="w3-transparence  w3-margin" >
        <div class="w3-container w3-padding w3-transparence " >
 <h1  class=" text-center font-weight-bold text-BLUE ">Admin Login</h1>
        </div>
  ...
  <form class="modal-content animate" action="adminlogin.php" method="post">
     ...
     <p> <input type="email" class="w3-input w3-border" placeholder="Enter e-mail" name="email" style="width:100%"  required></p>

      <label for="pswd"><b>Password</b></label>
     <p> <input type="password" class="w3-input w3-border" placeholder="Enter Password" name="admin_pswd" style="width:100%" required></p>
