...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid ">
    <div class="navbar-header">        
      ...
      <a class="navbar-brand text-dark" href="#myPage"><strong>Tele-Nutritionist(Doctor Homepage)</strong></a>
...
<li><a href="../CSE499/messages/d_message.php"><i class="fa fa-comments"><?php if($count1>0)
{
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox" >
      <div class="item active">
        <img src="../CSE499/pic/doc_home.jpg" alt="img1" width="1500" height="800" title="Doctor Home Page">
