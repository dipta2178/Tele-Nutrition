...
<!DOCTYPE >
<html>
<head><title>Tele-Nutritionist</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid ">
    <div class="navbar-header">
      <a class="navbar-brand text-white" href="#myPage"><strong>Tele-Nutritionist</strong></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#">Rrgistration<span class="caret"></span></a>
          <ul class="dropdown-menu">
                  <li><a href="doctor_login.php">Doctor</a></li>
                  <li><a href="login.php">Patient</a></li>
                  </ul>
    ...
    <li>  <a href='dentist.php'>Dentist</a></li>
     ...
     <li>  <a href='gynecologist.php'>Gynecologist</a></li>
        ...
        <li><a href="disease_prediction.php">Google Map</a></li>
        
          
     
   <li> <a href="#contact" onclick="toggleFunction()">Contact Us</a></li>
      
            	<li><a href="../CSE499/Admin/notification.php">Notification<?php if($count>0)
{
...
<footer class="text-center">
  ...
  <p>Copyright<a href="http://labaidgroup.com/specialized/doctor" data-toggle="tooltip" title="Tele-Nutritionist">@Tele-Nutritionist</a></p> 
</footer>
<script>
