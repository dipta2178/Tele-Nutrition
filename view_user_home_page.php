...
<style>
 ...
 body {
      ...
      color: #777;
     background-image:url(../CSE499/pic/user_home.jpg);
...
<h2><span style="color: black"><marquee behavior="scroll" direction="left"
           ...
           onmouseout="this.start();"><b>24 Hours Open for All...</b></marquee></span></h2>
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid ">
    <div class="navbar-header">       
     <a class="navbar-brand text-dark" href="#myPage"><strong>Tele-Nutritionist(Patient Homepage)</strong></a>
...
<li><a href="../CSE499/View_Doctor_Appointment_Schedule/doctor_schedule_list.php">Booking Appointment</a></li>
...
<li><a href="view_users_appointment.php">My Appointments</a></li>
  ...
  <li class="dropdown">
          ...
          <ul class="dropdown-menu"> 
<li><a href="../CSE499/view_consulting_hour/doctor_schedule_list.php">Consulting Hour</a></li>

<li><a href="../CSE499/messages/message.php">Consultation</a></li>
        </ul>
        </li>


  <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#Appointment">Extra Care<span class="caret"></span></i></a>
          <ul class="dropdown-menu"> 
<li><a href="../CSE499/user/COVID19.php">Covid-19</a></li>

<li><a href="../CSE499/user/pregnantWomen.php">Pregnant Women</a></li>
        </ul>
        </li>
